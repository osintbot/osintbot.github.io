...
* [PassSearch](https://vk.cc/czjFmJ) — бесплатно проверяет электронную почту на утечки данных до десяти раз в день. Если утечка обнаружена, бот выдаст пароли, которые были актуальны на момент взлома.
