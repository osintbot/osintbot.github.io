...
* Kinectify: Программное обеспечение для борьбы с отмыванием денег и соблюдения требований, включая оптимизированные инструменты для узнавания каждого клиента.
* Scam Sniffer: Расширение браузера, предупреждающее вас, как только обнаружится фишинговый сайт, представляющий угрозу для криптовалюты.
* PeckShieldAlert: Компания PeckShield, занимающаяся безопасностью блокчейна и аналитикой данных, с плагином.
* Sunrise: NFT Scam Protector: Плагин для многоуровневой защиты от мошенничества с NFT.
